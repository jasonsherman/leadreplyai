  ...
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-br from-purple-600 to-blue-500">
      ...
      <main className="flex-1 w-full">
        <div className="max-w-6xl mx-auto flex flex-col items-center p-4 md:p-8 w-full">
          <div className="w-full mt-16 flex flex-col md:flex-row gap-8">
          ...
          <div className="w-full bg-white rounded-xl shadow-xl mt-12 overflow-hidden transition-all duration-300 ease-in-out">
            {emailData ? (
